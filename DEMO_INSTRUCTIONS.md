...
```
Place the file in `.nexusvm-bridge` directory in the user home directory.
...
#### `bridge.toml`
Create a 'nexusvm-bridge-verifier-1' directory there and put the following `bridge.toml` file there:
```toml
[keys]
...
export KEY_DIR="nexusvm-bridge-verifier-1"
