...
use crate::client::client::NexusVMClient;
...
impl ClientCommand {
    ...
    pub fn get_status_command() -> Command {
        Command::new("status")
            .short_flag('s')
                    .about("Show the status of the NexusVM client")
        .after_help("Get the status of the NexusVM client.")
    }
