...
use super::client::NexusVMClientPrivateData;
...
pub fn get_private_data_from_file(path: &Path) -> NexusVMClientPrivateData {
    match read_file(path) {
        Some(data) => try_deserialize::<NexusVMClientPrivateData>(&data)
            .expect("Could not deserialize private data"),
        None => NexusVMClientPrivateData {
