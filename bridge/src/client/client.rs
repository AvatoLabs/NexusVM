...
pub struct NexusVMClientPrivateData {
...
pub struct NexusVMClient {
    ...
    data: NexusVMClientPublicData,
    latest_processed_file_name: Option<String>,
    remote_file_path: String,
    local_file_path: PathBuf,

    private_data: NexusVMClientPrivateData,
...
impl NexusVMClient {
    ...
    pub async fn new(
        ...
        let data = NexusVMClientPublicData {
            version: 1,
            peg_in_graphs: vec![],
            peg_out_graphs: vec![],
        };
    ...
    pub fn data(&self) -> &NexusVMClientPublicData {
        &self.data
    }

    pub fn data_mut(&mut self) -> &mut NexusVMClientPublicData {
        &mut self.data
    }
    ...
    pub fn private_data(&self) -> &NexusVMClientPrivateData {
        &self.private_data
    }
    ...
    Expected file syncing flow with data store:
     ...
     2. Fetch all files within 10 minutes (use timestamp)   ⎬ NexusVMClient::sync()
     3. Merge files                                         ⎭
     4. Client modifies file and clicks save                } NexusVMClient::<mutating operation>
     5. Fetch files that were created after fetching 1-2.   ⎫
     6. Merge with your file                                ⎬ NexusVMClient::flush()
    ...
    */
    ...
    ) -> (Option<NexusVMClientPublicData>, Option<String>) {
        let mut latest_valid_file: Option<NexusVMClientPublicData> = None;
        let mut latest_valid_file_name: Option<String> = None;
    ...
    pub async fn validate_data_by_key(
        &self,
        file_name: &str,
    ) -> (Option<NexusVMClientPublicData>, usize, usize) {
        let result = self
            .data_store
    ...
    pub async fn validate_data(client: &AsyncClient, data: &NexusVMClientPublicData) -> bool {
        println!(
    ...
    /// # Arguments
    ///
    /// * `data` - Must be valid data verified via `NexusVMClient::validate_data()` function
    pub fn merge_data(&mut self, data: NexusVMClientPublicData) {
        // peg-in graphs
    ...
    fn find_peg_in_or_fail<'a>(
        data: &'a mut NexusVMClientPublicData,
    ...
    //     graph: &mut CompiledNexusVMGraph,
    // ) {
...
impl ClientCliQuery for NexusVMClient {
