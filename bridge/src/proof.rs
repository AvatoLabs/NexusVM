...
// TODO: Consider importing `gen_correct_proof` fn from nexusvm/src/chunker/disprove_execution.rs
// It requires refactoring nexusvm crate
// Copied from nexusvm/src/chunker/disprove_execution.rs
#[derive(Copy)]
