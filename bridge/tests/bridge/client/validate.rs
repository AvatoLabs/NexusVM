...
use bridge::{
    client::client::{NexusVMClient, NexusVMClientPublicData},
...
async fn test_validate_success() {
    ...
    let result = NexusVMClient::validate_data(&esplora, &data).await;
...
async fn setup_and_create_graphs() -> (AsyncClient, NexusVMClientPublicData, OutPoint) {
