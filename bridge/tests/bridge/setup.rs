...
use bridge::{
    client::{
        chain::chain_adaptor::get_chain_adaptor, client::NexusVMClient, esplora::get_esplora_url,
    },
...
pub struct SetupConfig {
    pub network: Network,
    pub client_0: NexusVMClient,
    pub client_1: NexusVMClient,
...
pub async fn setup_test() -> SetupConfig {
    ...
    let client_0 = NexusVMClient::new(
    ...
    let client_1 = NexusVMClient::new(
        Some(get_esplora_url(source_network)),
        source_network,
        destination_network,
        Some(get_chain_adaptor(destination_network, None, None)),
